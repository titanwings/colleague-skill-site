...
The marketplace uses the same visual language as
[archify](https://tt-a1i.github.io/archify/): warm paper surfaces, near-black
ink, **one** burnt-orange accent, and colour reserved for meaning. Colour names
are semantic; a page should not need to know whether it is light or dark.
