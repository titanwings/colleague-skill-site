...
how to roll it back. Screenshots live in `(local) `, machine-readable
capture receipts in `(local) `.
...
Output: `(local) <label>-<page>-<theme>[-mobile].jpg` plus
...
| Page | Height (desktop) | Console errors | Overflow | Screenshot | — | --- | --- | --- | --- | --- | — | `/` | 5997 px | 0 | none | `images/before-home.jpg` (hero: `before-home-hero.jpg`) | — | `/gallery/` | 2463 px | 0 | none | `images/before-gallery.jpg` | — | `/gallery/boss-skill/` | 1389 px | 0 | none | `images/before-detail.jpg` |
...
| Check | Result | — | --- | --- | — | `npm run build` (217 pages) | pass, 1.4 s | — | `node scripts/capture.mjs --label pr-01-design-system` | 12/12 captures, **0 console errors, 0 overflow** | — | Computed body colours (light) | `rgb(239,242,241)` on `rgb(21,24,27)` = 15.6:1 | — | Computed body colours (dark) | `rgb(15,18,22)` on `rgb(235,240,244)` = 15.2:1 | — | Existing catalog rendering | 217 pages still built from the same 215 YAML entries |

**Before → after**

| Page | Before | After (this PR) | — | --- | --- | --- | — | Home (desktop, light) | `before-home.jpg` | `pr-01-design-system-home-light.jpg` | — | Home (desktop, dark) | — (site had no light/dark switch) | `pr-01-design-system-home-dark.jpg` | — | Gallery | `before-gallery.jpg` | `pr-01-design-system-gallery-light.jpg` | — | Detail | `before-detail.jpg` | `pr-01-design-system-detail-light.jpg` |
...
| Page | Live baseline | This PR (after the fix) | — | --- | --- | --- | — | `/` (desktop) | 5997 px | 5997 px | — | `/gallery/` | 2463 px | 2463 px | — | `/gallery/boss-skill/` | 1389 px | 1389 px |
