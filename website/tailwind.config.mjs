 ...
 *
 * The palette follows the "paper & ink" system used by archify
 * (https://tt-a1i.github.io/archify/): warm paper surfaces, near-black ink,
 * a single burnt-orange accent, and colour used only for semantics.
 *
